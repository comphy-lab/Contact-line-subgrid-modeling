"""Validate the linearized GLE solution against a digitized reference.

The reference data (`reference-data/kansal-minkush-linearized.csv`) digitises
the linearized-GLE reference solution of Kansal et al., Eur. Phys. J. Spec.
Top. (2024), DOI: 10.1140/epjs/s11734-024-01443-5, via Minkush's code.
Salvaged from PR #12 by amanb1901.
"""
...
try:
    data_path = Path(__file__).resolve().parent / 'reference-data' / 'kansal-minkush-linearized.csv'
